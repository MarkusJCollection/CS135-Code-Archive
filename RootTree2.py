...
#specific to trees.
    ...
    #recursive method to find depth of vertex
    #6
    #
    #
    #
    ...
    def depthActual(self,v):
        """Recursively finds the depth of a given vertex."""
        if v == self.root:
            return 0
        else:
            return 1+self.depthActual(self.parent(v))
